...
<head>
    ...
    .main-content {
        display: flex;
        justify-content: center; /* Mengatur baris berada di tengah-tengah */
        align-items: center;
        height: 300px; /* Menyesuaikan tinggi viewport */
    }
    ...
    .row {
        display: flex;
        align-items: center; /* Mengatur elemen di dalam baris berada di tengah-tengah */
    }

    .col-md-4 {
        margin-bottom: 30px; /* Memberikan jarak antara setiap kolom */
        border-radius: 8px; /* Mengatur sudut kartu */
    }

    .card-body {
        padding: 20px; /* Mengatur padding dalam kartu */
    }

    .icon-big {
        font-size: 3em; /* Ukuran ikon besar */
        color: #fff; /* Warna ikon putih */
    }

    .text-center {
        text-align: center; /* Teks diatur menjadi tengah */
    }

    .card-category {
        font-size: 14px; /* Ukuran kategori teks */
        color: rgba(255, 255, 255, 0.7); /* Warna teks kategori */
        margin-bottom: 10px; /* Jarak antara kategori dan judul */
    }

    .card-title {
        font-size: 24px; /* Ukuran judul kartu */
...
<body>
    <div class="header">
        ...
        <div>
            <a href="dashboardpemasukkan">
                    <h3 class="text-secondary font-weight-bold float-left logo">Pemasukkan</h3>
            </a>
        </div>
        <div>
            <a href="dashboardpengeluaran">
                    <h3 class="text-secondary font-weight-bold float-left logo">Pengeluaran</h3>
            </a>
        </div>
        <div class="right">
        ...
        <div class="row">
            <div class="col-md-4">
                        <div class="text-center">
                            <p class="card-category" style="color:black">Sisa Saldo</p>
                            <h4 class="card-title" style="color:black">Rp. <?=$saldoFix;?></h4>
                        </div>
            </div>

            <div class="col-md-4">
                        <div class="text-center">
                            <p class="card-category" style="color:black">Pengeluaran</p>
                            ...
                            <h4 style="color:black">Rp. <?= $hasilHargaPengeluaran; ?></h4>
                            <?php else : ?>
                            <h4 style="color:black">Rp. 0</h4>
                            <?php endif; ?>
                        </div>
            </div>
            ...
            <div class="col-md-4">
                        <div class="text-center">
                            <p class="card-category" style="color:black">Pemasukkan</p>
                            ...
                            if ( $hasilHarga != "" ) : ?>
                            <h4 style="color:black">Rp. <?= $hasilHarga ?> </h4>
                            <?php else : ?>
                            <h4 style="color:black">Rp. 0 </h4>
                            <?php endif; ?>
                        </div>
